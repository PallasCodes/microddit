<template>
  <nav class="md:hidden flex bg-white fixed w-full bottom-0 py-2 border-t border-gray-200 gap-5 text-indigo-700">
    <div v-if="!isAuthenticated" class="flex justify-center w-full">
    ...
    <div v-if="isAuthenticated" class="items-center justify-center gap-3 flex w-full">
      <router-link :to="`/user/${$store.getters.username}`">
