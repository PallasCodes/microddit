<template>
  <header class="bg-gray-800 text-white sticky top-0 z-10">
    <nav class="flex items-center py-2 justify-between px-2 md:px-0">
      ...
      <form @submit.prevent="search" class="flex items-center rounded overflow-hidden w-40 md:w-80">
        <input type="text" class="p-1 text-gray-700 h-6 md:h-auto w-full" v-model="query" />
